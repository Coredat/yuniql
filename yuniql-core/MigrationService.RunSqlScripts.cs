    ...
    {       
        ...
        )
        {
            ...
            try
            {
                ...
                sqlScriptFiles = _directoryService.SortFiles(scriptDirectory, environments, sqlScriptFiles).ToList();
            ...
            )
        {
            ...
            //we also make sure its sorted by file name or using an in-place sort order manifest in the directory
            sqlScriptFiles = _directoryService.SortFiles(workspace, environments, sqlScriptFiles).ToList();
        ...
        )
        {
            ...
            //we also make sure its sorted by file name or using an in-place sort order manifest in the directory
            bulkFiles = _directoryService.SortFiles(workspace, environments, bulkFiles).ToList();
